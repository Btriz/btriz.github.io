import{r,j as e}from"./vendor-BcAgOacr.js";const x=({text:a,icon:o,className:i="",...c})=>{const t=!!o,n=o,[s,l]=r.useState(!1);r.useEffect(()=>{l("ontouchstart"in window||navigator.maxTouchPoints>0)},[]);const u=`
