import{j as i,a9 as p,r as u}from"./vendor-Cbn3c-eS.js";import{u as m}from"./index-bckmmZW2.js";import{m as l}from"./framer-vendor-CWvZ-ENp.js";const c=t=>({initial:"initial",animate:"enter",exit:"exit",variants:t}),f=(t,e)=>({initial:{d:t},enter:{d:e,transition:o},exit:{d:t,transition:o}}),o={duration:.75,delay:.3,ease:[.76,0,0,.24]},h={initial:{top:"-300px"},enter:{top:"-100vh",transition:o,transitionEnd:{top:"100vh"}},exit:{top:"-300px",transition:o}},v={initial:{opacity:1},enter:{opacity:0,top:-100,transition:o,transitionEnd:{top:"48%"}},exit:{opacity:1,top:"40%",transition:{duration:.5,delay:.8,ease:[.33,1,.68,1]}}},$=({height:t,width:e})=>{const n=`
    M0 300
    Q${e/2} 0 ${e} 300
    L${e} ${t+300}
    Q${e/2} ${t+600} 0 ${t+300}
